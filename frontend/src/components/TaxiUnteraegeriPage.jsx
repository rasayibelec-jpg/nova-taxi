...
const TaxiUnteraegeriPage = () => {
  return (
    <>
      <Helmet>
        <title>Taxi Unterägeri – Taxi Turlihof | Flughafentransfer & Taxi-Service</title>
        <meta name="description" content="Taxi Turlihof - Ihr zuverlässiger Taxi-Service in Unterägeri. Flughafentransfer nach Zürich und Basel. Jetzt buchen: 076 611 31 31" />
        <meta name="keywords" content="Taxi Unterägeri, Flughafentransfer Unterägeri, Taxi Service Unterägeri" />
        <link rel="canonical" href="https://taxiturlihof.ch/taxi-unteraegeri" />
      </Helmet>
      <div className="min-h-screen bg-black text-white">
        <Header />
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-black">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">Taxi Unterägeri – Schnell & Zuverlässig</h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">Ihr Taxi-Service in Unterägeri, Zug</p>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black">
          <div className="max-w-4xl mx-auto">
            <div className="bg-gray-900 rounded-lg shadow-xl p-8 mb-12">
              <h2 className="text-3xl font-bold mb-6 text-white">Taxi & Flughafentransfer in Unterägeri</h2>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">Taxi Turlihof bietet in Unterägeri einen professionellen Taxi-Service. Ob Flughafentransfer nach Zürich oder Basel, Stadtfahrten – wir bringen Sie sicher ans Ziel.</p>
              <div className="grid md:grid-cols-3 gap-6 mt-8">
                ...
                <div className="flex items-start space-x-3"><MapPin className="w-6 h-6 text-blue-500 flex-shrink-0 mt-1" /><div><h3 className="font-semibold text-white mb-1">Lokal</h3><p className="text-gray-400 text-sm">In Unterägeri</p></div></div>
...
export default TaxiUnteraegeriPage;