...
const TaxiKriensPage = () => {
  return (
    <>
      <Helmet>
        <title>Taxi Kriens – Taxi Turlihof | Flughafentransfer & Taxi-Service</title>
        <meta name="description" content="Taxi Turlihof - Ihr zuverlässiger Taxi-Service in Kriens. Flughafentransfer nach Zürich und Basel. Jetzt buchen: 076 611 31 31" />
        <link rel="canonical" href="https://taxiturlihof.ch/taxi-kriens" />
      </Helmet>
      <div className="min-h-screen bg-black text-white"><Header />
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-black">
          <div className="max-w-7xl mx-auto text-center"><h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">Taxi Kriens – Schnell & Zuverlässig</h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">Ihr Taxi-Service in Kriens, Luzern</p>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black"><div className="max-w-4xl mx-auto">
            <div className="bg-gray-900 rounded-lg shadow-xl p-8 mb-12"><h2 className="text-3xl font-bold mb-6 text-white">Taxi & Flughafentransfer in Kriens</h2>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">Taxi Turlihof bietet in Kriens einen professionellen Taxi-Service. Flughafentransfer, Stadtfahrten – wir sind Ihr Partner.</p></div>
