...
${b}`))}function O(){let a=new AbortController;return a.abort(Object.defineProperty(new p.BailoutToCSRError("Render in Browser"),"__NEXT_ERROR_CODE",{value:"E721",enumerable:!1,configurable:!0})),a.signal}function P(a){switch(a.type){case"prerender":case"prerender-runtime":let b=new AbortController;if(a.cacheSignal)a.cacheSignal.inputReady().then(()=>{b.abort()});else{let c=(0,k.getRuntimeStagePromise)(a);c?c.then(()=>(0,o.scheduleOnNextTick)(()=>b.abort())):(0,o.scheduleOnNextTick)(()=>b.abort())}return b.signal;case"prerender-client":case"prerender-ppr":case"prerender-legacy":case"request":case"cache":case"private-cache":case"unstable-cache":return}}function Q(a,b){let c=b.dynamicTracking;c&&c.dynamicAccesses.push({stack:c.isDebugDynamicAccesses?Error().stack:void 0,expression:a})}function R(a){let b=l.workAsyncStorage.getStore(),c=k.workUnitAsyncStorage.getStore();if(b&&c)switch(c.type){case"prerender-client":case"prerender":{let d=c.fallbackRouteParams;d&&d.size>0&&h.default.use((0,m.makeHangingPromise)(c.renderSignal,b.route,a));break}case"prerender-ppr":{let d=c.fallbackRouteParams;if(d&&d.size>0)return E(b.route,a,c.dynamicTracking);break}case"prerender-runtime":throw Object.defineProperty(new q.InvariantError(`\`${a}\` was called during a runtime prerender. Next.js should be preventing ${a} from being included in server components statically, but did not in this case.`),"__NEXT_ERROR_CODE",{value:"E771",enumerable:!1,configurable:!0});case"cache":case"private-cache":throw Object.defineProperty(new q.InvariantError(`\`${a}\` was called inside a cache scope. Next.js should be preventing ${a} from being included in server components statically, but did not in this case.`),"__NEXT_ERROR_CODE",{value:"E745",enumerable:!1,configurable:!0})}}function S(a){let b=l.workAsyncStorage.getStore(),c=k.workUnitAsyncStorage.getStore();if(b)switch(!c&&(0,k.throwForMissingRequestStore)(a),c.type){case"prerender-client":h.default.use((0,m.makeHangingPromise)(c.renderSignal,b.route,a));break;case"prerender-legacy":case"prerender-ppr":if(b.forceStatic)return;throw Object.defineProperty(new p.BailoutToCSRError(a),"__NEXT_ERROR_CODE",{value:"E394",enumerable:!1,configurable:!0});case"prerender":case"prerender-runtime":throw Object.defineProperty(new q.InvariantError(`\`${a}\` was called from a Server Component. Next.js should be preventing ${a} from being included in server components statically, but did not in this case.`),"__NEXT_ERROR_CODE",{value:"E795",enumerable:!1,configurable:!0});case"cache":case"unstable-cache":case"private-cache":throw Object.defineProperty(new q.InvariantError(`\`${a}\` was called inside a cache scope. Next.js should be preventing ${a} from being included in server components statically, but did not in this case.`),"__NEXT_ERROR_CODE",{value:"E745",enumerable:!1,configurable:!0});case"request":return}}let T=/\n\s+at Suspense \(<anonymous>\)/,U=RegExp(`\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at ${n.ROOT_LAYOUT_BOUNDARY_NAME} \\([^\\n]*\\)`),V=RegExp(`\\n\\s+at ${n.METADATA_BOUNDARY_NAME}[\\n\\s]`),W=RegExp(`\\n\\s+at ${n.VIEWPORT_BOUNDARY_NAME}[\\n\\s]`),X=RegExp(`\\n\\s+at ${n.OUTLET_BOUNDARY_NAME}[\\n\\s]`);function Y(a,b,c,d){if(!X.test(b)){if(V.test(b)){c.hasDynamicMetadata=!0;return}if(W.test(b)){c.hasDynamicViewport=!0;return}if(U.test(b)){c.hasAllowedDynamic=!0,c.hasSuspenseAboveBody=!0;return}else if(T.test(b)){c.hasAllowedDynamic=!0;return}else{var e,f;let g;if(d.syncDynamicErrorWithStack)return void c.dynamicErrors.push(d.syncDynamicErrorWithStack);let h=(e=`Route "${a.route}": Uncached data was accessed outside of <Suspense>. This delays the entire page from rendering, resulting in a slow user experience. Learn more: https://nextjs.org/docs/messages/blocking-route`,f=b,(g=Object.defineProperty(Error(e),"__NEXT_ERROR_CODE",{value:"E394",enumerable:!1,configurable:!0})).stack=g.name+": "+e+f,g);return void c.dynamicErrors.push(h)}}}var Z=((e={})[e.Full=0]="Full",e[e.Empty=1]="Empty",e[e.Errored=2]="Errored",e);function $(a,b){console.error(b),a.dev||(a.hasReadableErrorStacks?console.error(`To get a more detailed stack trace and pinpoint the issue, start the app in development mode by running \`next dev\`, then open "${a.route}" in your browser to investigate the error.`):console.error(`To get a more detailed stack trace and pinpoint the issue, try one of the following:
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`))}function _(a,b,c,d){if(d.syncDynamicErrorWithStack)throw $(a,d.syncDynamicErrorWithStack),new j.StaticGenBailoutError;if(0!==b){if(c.hasSuspenseAboveBody)return;let d=c.dynamicErrors;if(d.length>0){for(let b=0;b<d.length;b++)$(a,d[b]);throw new j.StaticGenBailoutError}if(c.hasDynamicViewport)throw console.error(`Route "${a.route}" has a \`generateViewport\` that depends on Request data (\`cookies()\`, etc...) or uncached external data (\`fetch(...)\`, etc...) without explicitly allowing fully dynamic rendering. See more info here: https://nextjs.org/docs/messages/next-prerender-dynamic-viewport`),new j.StaticGenBailoutError;if(1===b)throw console.error(`Route "${a.route}" did not produce a static shell and Next.js was unable to determine a reason. This is a bug in Next.js.`),new j.StaticGenBailoutError}else if(!1===c.hasAllowedDynamic&&c.hasDynamicMetadata)throw console.error(`Route "${a.route}" has a \`generateMetadata\` that depends on Request data (\`cookies()\`, etc...) or uncached external data (\`fetch(...)\`, etc...) when the rest of the route does not. See more info here: https://nextjs.org/docs/messages/next-prerender-dynamic-metadata`),new j.StaticGenBailoutError}function aa(a,b){return a.runtimeStagePromise?a.runtimeStagePromise.then(()=>b):b}},94783,(a,b,c)=>{"use strict";Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"unstable_rethrow",{enumerable:!0,get:function(){return function a(b){if((0,g.isNextRouterError)(b)||(0,f.isBailoutToCSRError)(b)||(0,i.isDynamicServerError)(b)||(0,h.isDynamicPostpone)(b)||(0,e.isPostpone)(b)||(0,d.isHangingPromiseRejectionError)(b)||(0,h.isPrerenderInterruptedError)(b))throw b;b instanceof Error&&"cause"in b&&a(b.cause)}}});let d=a.r(13091),e=a.r(73808),f=a.r(49640),g=a.r(1567),h=a.r(60384),i=a.r(96556);("function"==typeof c.default||"object"==typeof c.default&&null!==c.default)&&void 0===c.default.__esModule&&(Object.defineProperty(c.default,"__esModule",{value:!0}),Object.assign(c.default,c),b.exports=c.default)},60968,(a,b,c)=>{"use strict";Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"unstable_rethrow",{enumerable:!0,get:function(){return d}});let d=a.r(94783).unstable_rethrow;("function"==typeof c.default||"object"==typeof c.default&&null!==c.default)&&void 0===c.default.__esModule&&(Object.defineProperty(c.default,"__esModule",{value:!0}),Object.assign(c.default,c),b.exports=c.default)},73727,(a,b,c)=>{"use strict";Object.defineProperty(c,"__esModule",{value:!0});var d={ReadonlyURLSearchParams:function(){return f.ReadonlyURLSearchParams},RedirectType:function(){return h.RedirectType},forbidden:function(){return j.forbidden},notFound:function(){return i.notFound},permanentRedirect:function(){return g.permanentRedirect},redirect:function(){return g.redirect},unauthorized:function(){return k.unauthorized},unstable_isUnrecognizedActionError:function(){return m},unstable_rethrow:function(){return l.unstable_rethrow}};for(var e in d)Object.defineProperty(c,e,{enumerable:!0,get:d[e]});let f=a.r(20916),g=a.r(44868),h=a.r(28859),i=a.r(16155),j=a.r(34557),k=a.r(93845),l=a.r(60968);function m(){throw Object.defineProperty(Error("`unstable_isUnrecognizedActionError` can only be used on the client."),"__NEXT_ERROR_CODE",{value:"E776",enumerable:!1,configurable:!0})}("function"==typeof c.default||"object"==typeof c.default&&null!==c.default)&&void 0===c.default.__esModule&&(Object.defineProperty(c.default,"__esModule",{value:!0}),Object.assign(c.default,c),b.exports=c.default)},70396,37765,a=>{"use strict";a.i(73727),a.s([],70396);let b={"arth-goldau":{title:"Taxi Arth-Goldau | Nova Taxi",metaDescription:"Nova Taxi – Ihr moderner Taxi-Service in Arth-Goldau. Pünktliche Fahrten, Flughafentransfers und Businessfahrten in der ganzen Zentralschweiz.",h1:"Taxi in Arth-Goldau",intro:"Mit Nova Taxi erreichen Sie Arth-Goldau, Luzern, Zug und den Flughafen Zürich komfortabel und zuverlässig – rund um die Uhr.",highlightPoints:["Verlässliche Fahrten zwischen Arth-Goldau und den wichtigsten Verkehrsknoten","Ideale Lage für Fahrten Richtung Luzern, Zug und Innerschweiz","Praktisch für Pendler, Reisende und Ausflüge in die Region Rigi"]},luzern:{title:"Taxi Luzern | Nova Taxi",metaDescription:"Nova Taxi – moderner Taxi-Service in Luzern. Flughafentransfer, Stadtfahrten, Hoteltransfers und mehr – zuverlässig und pünktlich.",h1:"Taxi in Luzern",intro:"Ob Altstadt, Bahnhof oder Seeufer – Nova Taxi bringt Sie in Luzern sicher und entspannt ans Ziel.",highlightPoints:["Flexibler Taxi-Service im gesamten Stadtgebiet","Direkte Verbindungen zu Hotels, Restaurants und Event-Locations","Perfekt für Touristinnen, Geschäftsreisende und Einheimische"]},zug:{title:"Taxi Zug | Nova Taxi",metaDescription:"Nova Taxi – zuverlässiger Taxi-Service in Zug. Businessfahrten, Flughafentransfer und individuelle Fahrten in der ganzen Region.",h1:"Taxi in Zug",intro:"Für Geschäfts- und Privatkunden in Zug – Nova Taxi verbindet Sie mit Flughafen, Meetings und Nachbarorten.",highlightPoints:["Diskrete Businessfahrten im Wirtschaftsraum Zug","Planbare Transfers zu Flughäfen und wichtigen Bahnhöfen","Angenehme Fahrten für Kundentermine und Abendveranstaltungen"]},schwyz:{title:"Taxi Schwyz | Nova Taxi",metaDescription:"Nova Taxi – Ihr Taxi in Schwyz und Umgebung. Fahrten ins Ortszentrum, zu Bahnhöfen, Hotels und Ausflugszielen.",h1:"Taxi in Schwyz",intro:"Ob Dorfzentrum, Mythenregion oder umliegende Gemeinden – Nova Taxi bringt Sie in Schwyz bequem von A nach B.",highlightPoints:["Regionale Fahrten in und um Schwyz","Anschluss an wichtige Zug- und Busverbindungen","Ideal für Alltagswege, Ausflüge und Abendfahrten"]},goldau:{title:"Taxi Goldau | Nova Taxi",metaDescription:"Nova Taxi – Taxi-Service in Goldau. Schnell verfügbar für Fahrten zum Bahnhof Arth-Goldau, in Nachbardörfer und zum Flughafen.",h1:"Taxi in Goldau",intro:"Von Goldau aus sind Sie mit Nova Taxi bestens mit Bahnhof, Rigi-Region und den umliegenden Orten verbunden.",highlightPoints:["Kurze Wege zum Bahnhof Arth-Goldau","Praktisch für Pendler und Tagesgäste","Flexible Fahrten auch am Abend und Wochenende"]},vitznau:{title:"Taxi Vitznau | Nova Taxi",metaDescription:"Nova Taxi – Ihr Taxi in Vitznau. Fahrten entlang des Vierwaldstättersees, zu Hotels, Schiffstation und Rigi-Bahn.",h1:"Taxi in Vitznau",intro:"In Vitznau begleitet Nova Taxi Sie zu Hotels, Kurorten und zur Rigi-Bahn – entspannt am Vierwaldstättersee unterwegs.",highlightPoints:["Transfers zu Seehotels und Wellness-Angeboten","Anschluss an Schiff und Bergbahn","Angenehme Rückfahrten nach Events und Abendessen"]},weggis:{title:"Taxi Weggis | Nova Taxi",metaDescription:"Nova Taxi – Taxi-Service in Weggis. Ideal für Hotelgäste, Ausflüge und Fahrten Richtung Luzern und Küssnacht.",h1:"Taxi in Weggis",intro:"Zwischen See und Rigi – Nova Taxi bringt Sie von Weggis aus komfortabel zu Ihren Zielen in der Zentralschweiz.",highlightPoints:["Transfers zu Hotels und Ferienwohnungen","Fahrten zu Schiffsstationen und Aussichtspunkten","Gute Verbindung nach Luzern, Küssnacht und Arth-Goldau"]},kuessnacht:{title:"Taxi Küssnacht am Rigi | Nova Taxi",metaDescription:"Nova Taxi – zuverlässiger Taxi-Service in Küssnacht am Rigi. Fahrten nach Luzern, Weggis, Arth-Goldau und in die Region.",h1:"Taxi in Küssnacht am Rigi",intro:"Ob Seeufer, Dorfzentrum oder Nachbarorte – Nova Taxi verbindet Küssnacht mit Luzern, Weggis, Arth-Goldau und mehr.",highlightPoints:["Schnelle Verbindungen entlang des Vierwaldstättersees","Praktische Fahrten zu Arbeitsorten und Schulen","Angenehme Abend- und Wochenendfahrten"]},root:{title:"Taxi Root | Nova Taxi",metaDescription:"Nova Taxi – Taxi-Service in Root und Umgebung. Fahrten nach Luzern, Zug, Ebikon und an wichtige Verkehrsknoten.",h1:"Taxi in Root",intro:"Von Root aus bringt Nova Taxi Sie zügig nach Luzern, Zug oder zu umliegenden Gemeinden und Bahnhöfen.",highlightPoints:["Ideal für Pendler zwischen Luzern und Zug","Anbindung an Industrie- und Gewerbezonen","Flexible Fahrten frühmorgens und abends"]},meggen:{title:"Taxi Meggen | Nova Taxi",metaDescription:"Nova Taxi – Ihr Taxi in Meggen. Bequeme Fahrten nach Luzern, an den See und zu Wohn- und Geschäftsadressen.",h1:"Taxi in Meggen",intro:"Zwischen Dorfkern, See und Stadt Luzern – Nova Taxi sorgt in Meggen für entspannte Fahrten im Alltag.",highlightPoints:["Kurzstrecken innerhalb von Meggen","Schnelle Transfers nach Luzern und Umgebung","Komfortable Fahrten für Familien und Berufstätige"]},gersau:{title:"Taxi Gersau | Nova Taxi",metaDescription:"Nova Taxi – Taxi-Service in Gersau. Fahrten entlang des Sees, Richtung Brunnen, Vitznau und Schwyz.",h1:"Taxi in Gersau",intro:"In Gersau begleitet Nova Taxi Sie zu Seehotels, Wandergebieten und den Nachbarorten entlang des Vierwaldstättersees.",highlightPoints:["Anfahrt auch auf kurvigen Seestrassen","Anschluss an Schiff und Bus","Bequeme Rückfahrten nach Ausflügen und Restaurantbesuchen"]},emmen:{title:"Taxi Emmen | Nova Taxi",metaDescription:"Nova Taxi – Taxi in Emmen und Emmenbrücke. Fahrten in Wohngebiete, Einkaufszentren und nach Luzern.",h1:"Taxi in Emmen",intro:"Von Emmen und Emmenbrücke aus bringt Nova Taxi Sie zuverlässig nach Luzern, in Industrie- und Wohngebiete.",highlightPoints:["Fahrten zu Einkaufszentren und Arbeitsplätzen","Gute Verbindung zu Bahnhof und Buslinien","Flexibel für Schichtarbeit und Abendtermine"]},rotkreuz:{title:"Taxi Rotkreuz | Nova Taxi",metaDescription:"Nova Taxi – Ihr Taxi in Rotkreuz. Fahrten zu Firmen, Schulen, Bahnhof und Richtung Zug, Luzern und Zürich.",h1:"Taxi in Rotkreuz",intro:"Rotkreuz ist ein wichtiger Knotenpunkt zwischen Luzern und Zug – Nova Taxi verbindet Sie mit Arbeitsorten und Bahnhöfen.",highlightPoints:["Transfers zum Bahnhof Rotkreuz","Praktisch für Pendler und Schüler","Direkte Fahrten zu Firmenstandorten und Events"]},walchwil:{title:"Taxi Walchwil | Nova Taxi",metaDescription:"Nova Taxi – Taxi-Service in Walchwil. Fahrten am Zugersee entlang nach Zug, Arth-Goldau und in Nachbarorte.",h1:"Taxi in Walchwil",intro:"Mit Blick auf den Zugersee – Nova Taxi bringt Sie von Walchwil aus komfortabel nach Zug, Arth-Goldau und Umgebung.",highlightPoints:["Panoramafahrten am See entlang","Verbindung zu Bahn und Bus","Ideal für Pendler und Freizeitfahrten"]},unteraegeri:{title:"Taxi Unterägeri | Nova Taxi",metaDescription:"Nova Taxi – Taxi in Unterägeri. Fahrten nach Zug, Oberägeri und zu Freizeit- und Arbeitsorten in der Region.",h1:"Taxi in Unterägeri",intro:"Zwischen See und Hügeln – Nova Taxi verbindet Unterägeri mit Zug, Oberägeri und den umliegenden Gemeinden.",highlightPoints:["Fahrten zum Ägerisee und Freizeitangeboten","Schul- und Arbeitswege flexibel abdecken","Auch abends und am Wochenende verfügbar"]},ebikon:{title:"Taxi Ebikon | Nova Taxi",metaDescription:"Nova Taxi – Taxi-Service in Ebikon. Fahrten nach Luzern, Einkaufszentren und in Wohnquartiere.",h1:"Taxi in Ebikon",intro:"Von Ebikon aus gelangen Sie mit Nova Taxi schnell nach Luzern, in Einkaufszentren und umliegende Ortsteile.",highlightPoints:["Kurzstrecken innerhalb von Ebikon","Verbindungen zu öV-Haltestellen","Bequeme Fahrten mit Gepäck oder Einkäufen"]},kriens:{title:"Taxi Kriens | Nova Taxi",metaDescription:"Nova Taxi – Ihr Taxi in Kriens. Fahrten Richtung Luzern, Pilatusgebiet und in Wohn- und Geschäftsquartiere.",h1:"Taxi in Kriens",intro:"Ob Dorfzentrum, Mattenhof oder Pilatusgebiet – Nova Taxi sorgt in Kriens für zuverlässige Fahrten im Alltag.",highlightPoints:["Anbindung an Pilatus-Bahn und Luzern","Praktische Fahrten für Beruf, Schule und Freizeit","Auch für kurze Strecken innerhalb von Kriens"]},rothenburg:{title:"Taxi Rothenburg | Nova Taxi",metaDescription:"Nova Taxi – Taxi-Service in Rothenburg. Fahrten zu Wohngebieten, Unternehmen und nach Luzern und Emmen.",h1:"Taxi in Rothenburg",intro:"In Rothenburg verbindet Nova Taxi Wohnquartiere, Gewerbegebiete und Nachbarorte wie Luzern und Emmen.",highlightPoints:["Fahrten zu Arbeits- und Einkaufsorten","Gute Erreichbarkeit von Luzern und Region","Flexibel für Tages- und Abendfahrten"]},rothenthurm:{title:"Taxi Rothenthurm | Nova Taxi",metaDescription:"Nova Taxi – Taxi in Rothenthurm. Fahrten Richtung Schwyz, Arth-Goldau und in die umliegenden Dörfer.",h1:"Taxi in Rothenthurm",intro:"Zwischen Moorlandschaft und Bergen – Nova Taxi bringt Sie von Rothenthurm aus zuverlässig in die Region.",highlightPoints:["Regionale Fahrten zwischen Dörfern und Bahnhöfen","Praktisch für Pendler und Freizeitgäste","Auch bei winterlichen Verhältnissen unterwegs"]},adligenswil:{title:"Taxi Adligenswil | Nova Taxi",metaDescription:"Nova Taxi – Taxi-Service in Adligenswil. Fahrten nach Luzern, Meggen und in umliegende Ortschaften.",h1:"Taxi in Adligenswil",intro:"In Adligenswil sorgt Nova Taxi für bequeme Verbindungen nach Luzern, Meggen und in die nähere Umgebung.",highlightPoints:["Kurzstrecken im Dorf und zur Stadt Luzern","Ideal für Familien, Pendler und Seniorinnen","Flexible Fahrten tagsüber und abends"]},baar:{title:"Taxi Baar | Nova Taxi – Ihr Taxi in Baar, Kanton Zug",metaDescription:"Taxi Baar – Nova Taxi bringt Sie zuverlässig zum Flughafen Zürich, Bahnhof Zug und in die gesamte Zentralschweiz. 24h erreichbar.",h1:"Taxi in Baar",intro:"Von Baar aus verbindet Nova Taxi Sie schnell und bequem mit Zug, Luzern und dem Flughafen Zürich. Ihr zuverlässiges Taxi im Kanton Zug.",highlightPoints:["Schnelle Verbindung zum Bahnhof Zug und Flughafen Zürich","Ideal für Geschäftsreisende und Pendler","Günstiges Taxi in der Nähe – 24h verfügbar"]},cham:{title:"Taxi Cham | Nova Taxi – Flughafentransfer & Taxiservice",metaDescription:"Taxi Cham – Nova Taxi für Flughafentransfer Zürich, Business-Fahrten und Stadtfahrten. 24/7 erreichbar in Cham und Umgebung.",h1:"Taxi in Cham",intro:"In Cham am Zugersee ist Nova Taxi Ihr Partner für Flughafentransfers, Business-Fahrten und alltägliche Wege in der Zentralschweiz.",highlightPoints:["Flughafentransfer Zürich direkt ab Cham","VIP & Business Transfer für Firmenkunden","Bahnhof Taxi und lokale Fahrten"]},steinhausen:{title:"Taxi Steinhausen | Nova Taxi – 24h Taxi Zentralschweiz",metaDescription:"Taxi Steinhausen – schnell und zuverlässig zum Flughafen, Bahnhof oder Business-Termin. Nova Taxi – Ihr Taxi in der Zentralschweiz.",h1:"Taxi in Steinhausen",intro:"Steinhausen liegt zentral zwischen Zug und Cham. Nova Taxi verbindet Sie mit Bahnhöfen, Flughäfen und Geschäftsadressen.",highlightPoints:["Zentrale Lage – schnelle Verbindungen nach Zug und Cham","Flughafentaxi Zentralschweiz","Taxi mit Kindersitz auf Anfrage"]},brunnen:{title:"Taxi Brunnen | Nova Taxi – Ihr Taxi am Vierwaldstättersee",metaDescription:"Taxi Brunnen am Vierwaldstättersee – Nova Taxi für Hotelgäste, Touristen und Einheimische. Flughafentransfer und regionale Fahrten.",h1:"Taxi in Brunnen",intro:"Brunnen am Vierwaldstättersee – Nova Taxi bringt Sie zu Hotels, Schiffsstationen, Bahnhöfen und zum Flughafen Zürich.",highlightPoints:["Transfers für Hotelgäste und Touristen","Taxi von Brunnen zum Flughafen Zürich","Fahrten entlang des Vierwaldstättersees"]},einsiedeln:{title:"Taxi Einsiedeln | Nova Taxi – Taxi zum Kloster & Flughafen",metaDescription:"Taxi Einsiedeln – zuverlässige Fahrten zum Kloster, Bahnhof und Flughafen Zürich. Nova Taxi – Ihr 24h Taxi in der Zentralschweiz.",h1:"Taxi in Einsiedeln",intro:"Einsiedeln mit seinem berühmten Kloster – Nova Taxi verbindet den Wallfahrtsort mit Zürich, dem Flughafen und der Zentralschweiz.",highlightPoints:["Pilger- und Touristentransfers zum Kloster","Was kostet ein Taxi von Einsiedeln nach Zürich? Fragen Sie uns!","Bahnhof Taxi Einsiedeln"]},freienbach:{title:"Taxi Freienbach | Nova Taxi – Taxi Pfäffikon SZ & Umgebung",metaDescription:"Taxi Freienbach und Pfäffikon SZ – Nova Taxi für Geschäftsreisen, Flughafentransfer und lokale Fahrten am Zürichsee.",h1:"Taxi in Freienbach",intro:"Freienbach mit Pfäffikon SZ liegt strategisch am Zürichsee. Nova Taxi verbindet Sie mit Zürich, dem Flughafen und der Zentralschweiz.",highlightPoints:["Business-Transfer für Unternehmen in der Region","Flughafentransfer Zürich ab Pfäffikon SZ","Grossraumtaxi für Gruppen auf Anfrage"]},horw:{title:"Taxi Horw | Nova Taxi – Ihr Taxi bei Luzern",metaDescription:"Taxi Horw – Nova Taxi für Fahrten nach Luzern, zum Pilatus und Flughafen Zürich. 24h Taxi Zentralschweiz.",h1:"Taxi in Horw",intro:"Horw am Fusse des Pilatus – Nova Taxi verbindet Sie mit Luzern, dem Flughafen Zürich und touristischen Zielen in der Region.",highlightPoints:["Bahnhof Taxi Luzern und Horw","Transfers zur Pilatusbahn und Bergstationen","Taxi mit Kreditkarte bezahlen möglich"]},sursee:{title:"Taxi Sursee | Nova Taxi – Taxi im Luzerner Hinterland",metaDescription:"Taxi Sursee – Nova Taxi für Fahrten zum Bahnhof, Flughafen Zürich und in die Region. Günstig, schnell, zuverlässig.",h1:"Taxi in Sursee",intro:"Sursee im Luzerner Hinterland – Nova Taxi bringt Sie zum Bahnhof, Flughafen Zürich und zu Zielen in der ganzen Zentralschweiz.",highlightPoints:["Bahnhof Taxi Sursee – schnelle Abholung","Günstiges Taxi in der Nähe","24h Taxi auch nachts und am Wochenende"]}},c=Object.keys(b);a.s(["allLocationSlugs",0,c,"locations",0,b],37765)}];
